...
def test3b2():
    ...
    #featureExtractor = submission.extractWordFeatures
    featureExtractor = submission.extractCharacterFeatures(7)
...
grader.addBasicPart('3b-2-basic', test3b2, maxPoints=2, maxSeconds=20, description="test classifier on real polarity dev dataset")
...
grader.addManualPart('3d', 3) # error analysis
