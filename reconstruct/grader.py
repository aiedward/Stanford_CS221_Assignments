...
def add_parts_1(grader, submission):
    ...
    grader.addBasicPart('1b-2-basic', t_1b_2, maxPoints=1, maxSeconds=2)
    ...
    grader.addHiddenPart('1b-4-hidden', t_1b_4, maxPoints=5, maxSeconds=3)


def add_parts_2(grader, submission):
    grader.addManualPart('2a', 2)
    ...
    grader.addHiddenPart('2b-2-hidden', t_2b_2, maxPoints=3, maxSeconds=2)
    ...
    grader.addHiddenPart('2b-4-hidden', t_2b_4, maxPoints=3, maxSeconds=3)
...
def add_parts_3(grader, submission):
    ...
    grader.addBasicPart('3b-1-basic', t_3b_1, maxPoints=1, maxSeconds=2)
    ...
    grader.addBasicPart('3b-2-basic', t_3b_2, maxPoints=1, maxSeconds=2)
    ...
    grader.addHiddenPart('3b-3-hidden', t_3b_3, maxPoints=6, maxSeconds=3)
    ...
    grader.addHiddenPart('3b-4-hidden', t_3b_4, maxPoints=6, maxSeconds=3)
    ...
    grader.addHiddenPart('3b-5-hidden', t_3b_5, maxPoints=6, maxSeconds=3)

# Avoid timeouts during later non-basic parts.
grader.addBasicPart('init', lambda: getRealCosts(), maxPoints=0, maxSeconds=15)
